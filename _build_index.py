...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .hero-sub {{ font-family: 'Source Sans 3', sans-serif; font-size: clamp(16px, 1.9vw, 19px); color: var(--muted-2); margin: 20px auto 0; max-width: 40rem; line-height: 1.5; letter-spacing: .005em; }}
