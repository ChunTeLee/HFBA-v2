...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .huggiverse-title {{ font-family: var(--font-display); font-weight: 600; font-size: clamp(2.5rem, 6.5vw, 4.25rem); line-height: 1.0; letter-spacing: -.01em; color: #2A3138; margin: 0; }}
      .hero-sub {{ font-family: 'Source Sans 3', sans-serif; font-size: 17px; color: #6b7280; margin: 16px 0 0; max-width: 54ch; line-height: 1.5; }}
      .font-toggle {{ display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-top: 24px; }}
