...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .huggiverse-title {{ font-family: var(--font-display); font-weight: 600; font-size: clamp(2.4rem, 9vw, 6.75rem); line-height: 1.0; letter-spacing: -.01em; color: #2A3138; margin: 0; }}
      ...
      /* ---- Search ---- */
      #search-header {{ position: sticky; top: 0; z-index: 30; background: rgba(243,247,250,.9); backdrop-filter: blur(8px); }}
