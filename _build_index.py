...
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Always one line: truncate long names with an ellipsis so every card is the
         same height and the grid stays aligned at any screen size. min-width:0 lets
         the title shrink beside the download button in the flex row. */
      .asset-name {{ font-family: 'Source Sans 3', sans-serif; font-weight: 600; color: var(--ink); letter-spacing: -.005em; min-width: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }}
  ...
  <body>
    <script>
      /* theme locked to default (motion) — toggle hidden */
    </script>
